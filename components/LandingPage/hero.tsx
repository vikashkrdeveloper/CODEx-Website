    ...
    <section className=" min-h-screen flex items-center justify-center">
      <div className="max-w-7xl mx-auto px-6 text-center">
        ...
        <p className="text-xl md:text-2xl text-white opacity-90 max-w-3xl mx-auto mt-6 mb-10">
          Join <span className="font-semibold text-yellow-300">CODEx</span> – Where beginners
          transform into creators, innovators, and digital artists. Together, we code, design, and
          build the future.
        </p>
